/*1708702297,,JIT Construction: v1011606959,en_US*/
...
try {
    (window.FB && !window.FB.__buffer) || (function () {
        ...
        (function () {
            ...
            with (this) {
                ...
                (function (a) {
                    var b = {}, c = ["global", "require", "requireDynamic", "requireLazy", "module", "exports"],
                        d = ["global", "require", "importDefault", "importNamespace", "requireLazy", "module", "exports"],
                        e = 1, f = 32, g = 64, h = {}, i = Object.prototype.hasOwnProperty;
                    ...
                    function n(a, c, d, f) {
                        typeof d === "function" ? (b[a] = {
                            ...
                            special: f || 0,
                            resolved: !1
                        }, f != null && f & e && k.call(null, a)) : b[a] = {defaultExport: d, exports: d, resolved: !0}
                    }
                ...
                __d("ES6ArrayPrototype", [], (function (a, b, c, d, e, f) {
                    var g = {
                        find: function (a, b) {
                            ...
                            var d = Object(this), e = d.length >>> 0, f = arguments[1], g = f >> 0,
                                h = g < 0 ? Math.max(e + g, 0) : Math.min(g, e), i = arguments[2],
                                j = i === void 0 ? e : i >> 0, k = j < 0 ? Math.max(e + j, 0) : Math.min(j, e);
                            while (h < k) d[h] = a, h++;
                            return d
                        }
                    };
                ...
                __d("ES7ArrayPrototype", ["ES5Array", "ES5ArrayPrototype"], (function (a, b, c, d, e, f) {
                    var g = b("ES5Array").isArray, h = b("ES5ArrayPrototype").indexOf;
                    ...
                    a = {
                        includes: function (a) {
                            ...
                            var b = Object(this), c = b.length ? i(b.length) : 0;
                            if (c === 0) return !1;
                            var d = arguments.length > 1 ? j(arguments[1]) : 0, e = d < 0 ? Math.max(c + d, 0) : d,
                ...
                __d("json3-3.3.2", [], (function (a, b, c, d, e, f) {
                    ...
                    function j() {
                        (function () {
                            var b = typeof i === "function", c = {"function": !0, object: !0},
                ...
                __d("ES", ["ES5FunctionPrototype", "ES5StringPrototype", "ES6Array", "ES6ArrayPrototype", "ES6Number", "ES6Object", "ES7ArrayPrototype", "ES7Object", "ES7StringPrototype", "json3"], (function (a, b, c, d, e, f, g) {
                    var h = {}.toString, i = {"JSON.stringify": c("json3").stringify, "JSON.parse": c("json3").parse};
                    d = {"Function.prototype": c("ES5FunctionPrototype"), "String.prototype": c("ES5StringPrototype")};
                    e = {
                        Object: c("ES6Object"),
                    ...
                    function b(a, b, c) {
                        ...
                        if (Array.isArray(a)) if (typeof d === "string") e = i[d + "." + b]; else throw new Error("Can't polyfill " + b + " directly on an Array."); else if (typeof d === "string") e = i[d + "." + b]; else if (typeof a === "string") throw new Error("Can't polyfill " + b + " directly on a string."); else e = a[b];
                ...
                (function (a, b) {
                    ...
                    var g = a.FB_enumerate, h = function () {
                        ...
                        var b = "key", i = "value", j = "key+value", k = "$map_", l, m = "IE_HASH_", a = function () {
                            "use strict";
                ...
                __d("fb-error", ["performanceNowSinceAppStart", "removeFromArray"], (function (a, b, c, d, e, f) {
                    ...
                    function J(a) {
                        ...
                        a;
                        var c, d, e;
                        if (ES(a, "includes", !0, "charset=utf-8;base64,")) b = "<inlined-file>"; else {
                            var f;
                    ...
                    var M = {formatStackFrame: K, normalizeError: L, ifNormalizedError: ma}, na = "<global.react>",
                        N = [], O = [], P = 50, Q = !1, R = {
                    ...
                    function sa(a, b, c) {
                        ...
                        d = ra(a, b);
                        ES("Object", "assign", !1, d, {ancestors: V.slice(), clientWeight: X(e), page_position: X(W)});
                    ...
                    var ya = 20, za = function () {
                        ...
                        var b = a.prototype;
                        b.$1 = function (b, c) {
                            var d = String(c), e = this.events, f = this.project, h = this.metadata,
                                i = this.blameModule, j = this.forcedKey, k = this.error, l;
                            ...
                            }), l.message = C.toReadableMessage(l), j != null && (l.forcedKey = l.forcedKey != null ? j + "_" + l.forcedKey : j); else if (k) this.taalOpcodes.length > 0 && new a("fblogger").blameToPreviousFrame().blameToPreviousFrame().warn("Blame helpers do not work with catching"), C.aggregateError(k, {
                                messageFormat: d,
                            ...
                            if (!h.isEmpty()) if (l.metadata == null) l.metadata = h.format(); else {
                                var p = l.metadata.concat(h.format()), q = new Set(p);
                ...
                __d("IGIframeableMessageTypes", ["keyMirror"], (function (a, b, c, d, e, f, g) {
                    "use strict";
                    a = c("keyMirror")({LOADING: null, MEASURE: null, MOUNTED: null, UNMOUNTING: null});
                    b = a;
                    g["default"] = b
                }), 98);
                ...
                __d("PolarisEventListener", ["ExecutionEnvironment", "memoize"], (function (a, b, c, d, e, f, g) {
                    "use strict";
                    var h, i = !1, j = c("memoize")(function () {
                        try {
                            ...
                            (h || (h = c("ExecutionEnvironment"))).canUseDOM && (window.addEventListener("test", null, a), window.removeEventListener("test", null, a))
                        } catch (a) {
                        }
                        return i
                    }), k = {capture: !1};
                    a = function () {
                        ...
                        a.add = function (b, c, d, e) {
                            e === void 0 && (e = k);
                            var f = e;
                            j() || (f = typeof e !== "boolean" && !!e.capture);
                ...
                __d("polarisOnDOMReady", ["ExecutionEnvironment", "PolarisEventListener"], (function (a, b, c, d, e, f, g) {
                    ...
                    if ((h || c("ExecutionEnvironment")).canUseDOM) {
                        ...
                        d || (i = [], c("PolarisEventListener").add(document, "DOMContentLoaded", a), c("PolarisEventListener").add(window, "load", a))
                    }
                    g["default"] = b
                }), 98);
                __d("PolarisEmbedSDKImpl", ["invariant", "IGIframeableMessageTypes", "PolarisEmbedSDKContext", "PolarisEventListener", "polarisOnDOMReady"], (function (a, b, c, d, e, f, g, h) {
                    ...
                    var l = "data-instgrm-captioned", m = "instagram-embed-", n = 1e4,
                        o = "\n  background-color: white;\n  border-radius: 3px;\n  border: 1px solid #dbdbdb;\n  box-shadow: none;\n  display: block;\n  margin: 0;\n  min-width: 326px;\n  padding: 0;\n",
                        p = /^https?:\/\//, q = "https://", r = /^(.*?)\/?(\?.*|#|$)/, s = 3, t = "instagram-media",
                        u = t + "-registered", v = t + "-rendered",
                        w = new RegExp("^https?://([\\w-]+\\.)*(" + b.join("|") + ")$"), x = "data-instgrm-payload-id",
                        y = "instagram-media-payload-", z = "data-instgrm-permalink",
                        A = new RegExp("^(" + w.source.replace(/^\^/, "").replace(/\$$/, "") + "/p/[^/]+)"),
                        B = "data-instgrm-preserve-position",
                        C = new RegExp("^(" + w.source.replace(/^\^/, "").replace(/\$$/, "") + "/embed\\.js)"),
                        D = "data-instgrm-version", E = new RegExp("__d=(www|dis)"), F = {}, G = !1, H = {}, I = 0,
                        J = !1, K = {};
                            ...
                            case c("IGIframeableMessageTypes").MOUNTED:
                                ...
                                if (typeof f.styles === "object" && f.styles.length) try {
                                    for (var i = 0; i < f.styles.length; i++) {
                                        var k = f.styles[i][0], l = f.styles[i][1];
                                        b.style[k] = l
                                    }
                                } catch (a) {
                                }
                    ...
                    function V() {
                        ...
                        c("polarisOnDOMReady")(function () {
                            U(), G || (c("PolarisEventListener").add(window, "message", T.bind(a)), G = !0)
                        })
                    }
    ...
    i.src = 'https://www.facebook.com/platform/scribe_endpoint.php/?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script || "embed.js") + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1011606959","namespace":"FB","message":"' + e.message + '"}}');
